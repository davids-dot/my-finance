...
import argparse
import time
from my_finance.gold_price import GoldPriceTracker, print_gold_price
...
def main():
    ...
    parser.add_argument("-f", "--file", type=str, default="gold_price_history.csv",
                        help="CSV文件名，默认为gold_price_history.csv")
